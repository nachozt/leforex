...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { bank: @institution.bank, fee: @institution.fee, name: @institution.name } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { bank: @institution.bank, fee: @institution.fee, name: @institution.name } }
